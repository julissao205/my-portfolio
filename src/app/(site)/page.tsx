    ...
    <main className='relative overflow-hidden bg-[#0b101a] text-white'>
      ...
      <section className='relative mx-auto grid max-w-[1170px] gap-10 px-4 pt-36 pb-20 sm:px-8 lg:grid-cols-12 lg:items-center xl:px-0'>
        <div className='lg:col-span-7'>
          ...
          <p className='mb-8 max-w-2xl text-base leading-relaxed text-[#cbd5e1] sm:text-lg'>
        ...
        <div className='lg:col-span-5'>
          <div className='rounded-3xl border border-[#1e293b] bg-[#111827cc] p-6 shadow-2xl backdrop-blur'>
            ...
            <ul className='space-y-3 text-sm text-[#cbd5e1]'>
              <li className='rounded-lg border border-[#1f2937] bg-[#0f172a] p-3'>
      ...
      <section className='relative mx-auto max-w-[1170px] px-4 pb-24 sm:px-8 xl:px-0'>
        ...
        <div className='grid gap-6 md:grid-cols-2 lg:grid-cols-3'>
          <article className='rounded-2xl border border-[#1e293b] bg-[#111827cc] p-6 shadow-lg backdrop-blur'>
