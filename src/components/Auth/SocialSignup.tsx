  ...
  return (
    <>
      <button
        ...
        className='hover:border-purple flex w-full items-center justify-center gap-3 rounded-lg border border-white/[0.12] p-3.5 font-medium text-white duration-300 ease-in'
      >
        <svg
          width='23'
          height='22'
      ...
      <button
        ...
        className='hover:border-purple mt-4 flex w-full items-center justify-center gap-3 rounded-lg border border-white/[0.12] p-3.5 font-medium text-white duration-300 ease-in'
      >
        <svg
          fill='currentColor'
          width='22'
